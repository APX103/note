...
![通信领域若干关键里程碑的时间线](images/fig_0101.png)
...
![ADF7030 框图 [3]](images/fig_0102.png)
...
![构成现代数字通信系统的若干重要组成部分示意图。注意对基于 SDR 的实现而言，标注为可编程的那些组件既可以用可编程逻辑实现，也可以用软件实现](images/fig_0103.png)
...
![七层 OSI 模型与五层 TCP/IP 模型的对比](images/fig_0104.png)
...
![分组结构对 SDR 的影响，PLCP = 物理层收敛协议](images/fig_0105.png)
...
![多级超外差接收与发射信号链 [4]](images/fig_0106.png)
...
![Pluto SDR 所用的集成 ZIF 架构](images/fig_0108.png)
...
![DSP48E1 切片的基本功能 [5]](images/fig_0109.png)
