...
>
> ⚠️ **免责声明**：本书为基于公开资料的学习整理稿，不是原书的复制或翻译；所有硬件参数以 ST 官方最新文档为准，涉及实际接线与上电操作时请务必核对官方手册。电机运行实验请使用套件附带的安全低电压（12 V）进行。
...
- [第 1 章　STM32G4 概述](./Chapter_01_STM32G4概述.md)
- [第 2 章　STM32 电机控制套件 P-NUCLEO-IHM03](./Chapter_02_P-NUCLEO-IHM03套件.md)
- [第 3 章　软件开发环境](./Chapter_03_软件开发环境.md)

### 第二部分　基础实验（第 4 章）

- [第 4 章　NUCLEO-G431RB 基础实验](./Chapter_04_NUCLEO-G431RB基础实验.md)

### 第三部分　电机控制理论（第 5 ~ 6 章）

- [第 5 章　无刷直流电机控制技术](./Chapter_05_无刷直流电机控制技术.md)
- [第 6 章　永磁同步电机控制技术](./Chapter_06_永磁同步电机控制技术.md)

### 第四部分　实战案例（第 7 ~ 8 章）

- [第 7 章　基于 P-NUCLEO-IHM03 套件的电机入门控制实例](./Chapter_07_无感电机控制实例.md)
- [第 8 章　基于 P-NUCLEO-IHM03 套件的有感电机控制案例](./Chapter_08_有感电机控制案例.md)
- [附录与参考文献](./Chapter_09_附录与参考文献.md)

### 三条阅读路径

- **快速上手路径**（已有嵌入式基础）：第 2 章 → 第 3 章 → 第 7 章，半天内让电机转起来；缺理论再回读第 5、6 章。
- **理论补课路径**（会调 SDK 但想懂原理）：第 5 章 → 第 6 章，重点读坐标变换与 SVPWM 的几何解释，配合第 7 章把每个 SDK 概念对号入座。
